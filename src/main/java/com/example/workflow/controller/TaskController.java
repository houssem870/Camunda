...
public class TaskController {
    ...
    public void completeTaskChooseBook(@RequestBody TaskCompletionRequest taskCompletionRequest) {
      ...
      if (task != null) {
          ...
          runtimeService.setVariable(task.getProcessInstanceId(), "Niveau", "1");
    ...
    @PostMapping("/task2/complete")
    public void completeSecondTask(@RequestBody TaskCompletionRequest taskCompletionRequest) {
        TaskQuery taskop = taskService.createTaskQuery()
                .taskDefinitionKey("Activity_0317xsr")
                .orderByLastUpdated().asc();
        ...
        if (task != null) {
            ...
            runtimeService.setVariable(task.getProcessInstanceId(), "Niveau2", "2");
